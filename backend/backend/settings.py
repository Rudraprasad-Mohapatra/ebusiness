...
TEMPLATES = [
    {
        ...
        # include the frontend/templates directory so index.html (React build) is found
...
# Admin email address for receiving contact form submissions
ADMIN_EMAIL = os.getenv("ADMIN_EMAIL", "admin@radharaman.com")